...
class User_ND:
    ...
    async def walk(self) -> bool:
        ...
        try:
            # await Auth.auth(self.page, self.actions, self.auth_data)
    ...
    async def run(self):
        ...
        try:
            ...
            # self.actions.d_wait_random({"min": 5, "max": 10})
            ...
            if random.randint(0, 1): await Auth.auth(self.page, self.actions, self.auth_data)
            else: Sleep.zZz(random.randint(5, 10))
